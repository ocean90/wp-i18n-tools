...
(function($) {
	...
	function generatePassword() {
		...
		$( '#pw-weak-text-label' ).html( wp.i18n.__( 'Confirm use of weak password' ) );
	}
	...
	function resetToggle() {
		$toggleButton
			.data( 'toggle', 0 )
			.attr({
				'aria-label': wp.i18n.esc_attr__( 'Hide password' )
			})
			.find( '.text' )
				.text( wp.i18n.__( 'Hide' ) )
			.end()
			.find( '.dashicons' )
		...
		$toggleButton.show().on( 'click', function () {
			if ( 1 === parseInt( $toggleButton.data( 'toggle' ), 10 ) ) {
				...
				$toggleButton
					.data( 'toggle', 1 )
					.attr({
						'aria-label': wp.i18n.esc_attr__( 'Show password' )
					})
					.find( '.text' )
						.text( wp.i18n.__( 'Show' ) )
					.end()
					.find( '.dashicons' )
	...
	function check_pass_strength() {
		...
		switch ( strength ) {
			case -1:
				$( '#pass-strength-result' ).addClass( 'bad' ).html( wp.i18n._x( 'Password strength unknown', 'password strength' ) );
				break;
			case 2:
				$('#pass-strength-result').addClass('bad').html( wp.i18n._x( 'Weak', 'password strength' ) );
				break;
			case 3:
				$('#pass-strength-result').addClass('good').html( wp.i18n._x( 'Medium', 'password strength' ) );
				break;
			case 4:
				$('#pass-strength-result').addClass('strong').html( wp.i18n._x( 'Strong', 'password strength' ) );
				break;
			case 5:
				$('#pass-strength-result').addClass('short').html( wp.i18n._x( 'Mismatch', 'password mismatch' ) );
				break;
			default:
				$('#pass-strength-result').addClass('short').html( wp.i18n._x( 'Very weak', 'password strength' ) );
		}
	}
	...
	$( window ).on( 'beforeunload', function () {
		if ( true === updateLock ) {
			return wp.i18n.__( 'Your new password has not been saved.' );
		}
	} );
